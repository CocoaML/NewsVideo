...
-(void)setupGroup2
{
    ...
    MoreAbout.option = ^{
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"CocoaML" message:@"如有疑问，请联系\n15210235097@163.com\n技术交流，杜绝商业用途！" delegate:self cancelButtonTitle:nil otherButtonTitles:@"确定", nil];
        [alert show];
    };
...
- (void)LoginBtnClck:(NSString *)str
{
        ...
        NSArray *tarray = @[@"QQ",@"微博",@"账号登录"];
        NSArray *imageArray = @[@"登录QQ",@"登录微博",@"账号登录"];
        CGFloat hight = 80;
...
- (void)selfToLogin {
    ...
    LoginViewController *login = TL_INSTANT_VC_WITH_ID(@"Main", @"LoginViewController");
